...
> 엔진·에디터·빌드의 것만 적는다.
>
> **구현을 마친 항목은 지우지 않고 취소선으로 긋는다**(D-203). 끝에 언제(날짜·커밋)와 어디서(파일·함수) 고쳤는지 붙인다.
...
- `[진행]` **오디오**(D-197·D-198·D-201·D-202·D-203, [audio-plan.md](./audio-plan.md)). 일곱 단계(믹서·출력·에셋·2D/3D 소스·
  ...
  포커스 정책·웹 자동 재생 알림)가 섰다. 남은 것은 계획서 §5 의 `[열림]` 과 기존 백로그다.
...
- **D-203. 구현을 마친 남은 일은 지우지 않고 취소선으로 긋고, 언제·어디서 고쳤는지 붙인다.** (2026-09-26)
